...
getXListsFromClaims : List Claim -> List (List Int)
...
getYListsFromClaims : List Claim -> List (List Int)
...
updateGridFromYList : Int -> Dict String Int -> List Int -> Dict String Int
    ...
    case msg of
        ...
        ParseClaimsText ->
            let
                ...
                -- Attempt #2: 3409 is too low... probably because I left 0 200 hardcoded lol, whoops...
                -- Attempt #3: 122456 is too high... now I'm confused. I've worked so long on this I think it's time to whip out the JavaScript.
                -- Attempt #4 in JavaScript: 30189 is not correct... I left grid hardcoded again, lulz
                -- Attempt #5 in JavaScript: 211474 is not correct. I give up, lol!
                -- Attempt #6: Went to Reddit, found some JavaScript. Ran it, and got: 113576. Ported to Elm, got: 1192... WAT
